    ...
    return (
      <Html lang="pt-BR">
        <Head>
          <meta
            name="description"
            content="Cálcule o seu valor para cobrar em seus futuros jobs na plataforma"
          />
          <meta
            name="keywords"
            content="Jobs, trabalhos, freelancer, freelas, desenvolvimento"
          />
          ...
          <link
            rel="icon"
            sizes="144x144"
            href="/images/icons/android-icon-144x144.png"
          />
          ...
          <meta
            property="og:image"
            content="https://localhost:3000/images/rede-social.jpg"
          />
          <meta
          ...
          <meta
            name="twitter:image"
            content="http://localhost:3000/images/rede-social.jpg"
          />
          <meta
