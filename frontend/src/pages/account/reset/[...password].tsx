...
import { IoEyeOutline, IoArrowBackOutline, IoEyeOffOutline } from 'react-icons/io5';
...
const ResetPassword: React.FC = ({ token }: any) => {
  ...
  const handleResetPassword = useCallback(async (data: IResetPassword) => {
    try {
      ...
      <div className="bg-indigo-100 grid grid-cols-1 lg:grid-cols-2 ">
        <div className="bg-green-600 lg:min-h-screen lg:flex lg:items-center p-16 sm:p-20">
          <div className="flex-grow">
            ...
            <p className="text-center text-green-200 sm:text-lg">Realiza a troca de senha para continuar acessando sua conta.</p>
          </div>
        ...
        <div className="lg-min-h-screen lg:flex lg:items-center p-24 lg:p-24 sm:p-18 xl:p-12 2xl:p-48">
          <div className="flex-grow bg-white shadow-xl rounded-md border border-gray-300 p-8">
            <div className="text-center">
              <p className="text-2xl font-medium text-gray-900">REDEFINIÇÃO DE SENHA</p>
            </div>
