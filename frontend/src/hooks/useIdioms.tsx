...
export function useIdioms() {
  ...
  const ptBR = {
    ...
    pageTitleForgot: 'Recuperação da conta',
    titleForgot: 'Recuperação da conta',
    descriptionForgot: 'Insira seu email para procurar sua conta.',
    titleForgotForm: 'ENCONTRE SUA CONTA',
    buttonForgotForm: 'Continuar',

    pageTitleLogin: 'Entrar',
    titleLogin: 'Bem-vindo ao JobsManager',
    descriptionLogin: 'Faça login na plataforma.',
    titleLoginForm: 'FAÇA LOGIN NA SUA CONTA',
    inputLoginForm: 'Senha',
    textLinkLogin: 'Esqueceu a senha?',
    buttonLogin: 'Entrar',
    isMember: 'Não é um membro? Cadastre-se',
    ...
    titleSignupForm: 'CADASTRO',
    inputUsernameSignupForm: 'Nome de usuário',
    inputNameSignupForm: 'Nome',
    inputPasswordSignupForm: 'Senha',
    inputConfirmPasswordSignupForm: 'Digite a senha novamente',
